...
with strategy.scope():
    ...
    def encoder(input_shape=(64, 160, 2), latent_dim=128):
    ...
    def autoencoder(input_shape=(64, 160, 2), latent_dim=128):
    ...
    encoder_model = encoder(input_shape=(64, 160, 2), latent_dim=128)
    encoder_model.summary()

    # Định nghĩa mô hình decoder
    decoder_model = decoder(latent_dim=128)
    decoder_model.summary()

    # Định nghĩa mô hình autoencoder
    autoencoder_model = autoencoder(input_shape=(64, 160, 2), latent_dim=128)
    ...
    encoder_filename = f'encoder_params_dim128.mat'
    decoder_filename = f'decoder_params_dim128.mat'
